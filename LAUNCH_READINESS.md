...
- **Story 3 — Engagement shapes on `/services`.** Three shapes laid out clearly: AI Diagnostic Sprint (2wk), Build Sprint (6wk), Embedded AI Team (3-6mo). No published service prices. CTA to /contact on each.
...
No published service prices anywhere on the public site. The contact flow asks for the work surface, timeline, and constraints without a budget gate.
