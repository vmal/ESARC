...
export const caseStudy = {
  ...
  image: { src: logo },
  date: '2024-06',
  service: 'Whisper, OpenAI LLMs, Postgres + pgvector RAG, Next.js, Node',
  sector: 'Digital health / clinical workflow',
  length: '~12 months (co-founder, lead engineer)',
  metric: 'Zero to 100+ monthly clinician users in 3 months',
}
