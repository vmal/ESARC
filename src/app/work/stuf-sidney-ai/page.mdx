...
export const caseStudy = {
  ...
  image: { src: logo },
  date: '2025-09',
  service: 'Voice AI, NestJS + Prisma, Postgres, LLM dialogue management on an async-graph state machine',
  sector: 'Self-storage / proptech',
  length: '~12 months (Lead AI SWE)',
  metric: '150+ qualified leads at ISS Vegas, +25% demo success, -60% fallback prompts',
}
