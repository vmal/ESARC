...
export const caseStudy = {
  ...
  image: { src: logo },
  date: '2026-02',
  service: 'Vapi, Supabase (Postgres + RLS), Node, LLM-judge eval pipelines',
  sector: 'Multi-tenant voice AI SaaS',
  length: 'Ongoing (senior engineer)',
  metric: 'Multi-tenant voice agents in production with eval-gated releases',
}

export const metadata = {
  title: `${caseStudy.client} Case Study`,
  description: caseStudy.description,
  alternates: { canonical: '/work/mymethod' },
  openGraph: {
    type: 'article',
    url: '/work/mymethod',
