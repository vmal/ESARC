...
export const caseStudy = {
  ...
  image: { src: logo },
  date: '2025-12',
  service: 'Python, internal Meta stack, MCP, eval tooling',
  sector: 'Frontier AI research lab',
  length: 'Ongoing (senior IC contract)',
  metric: 'Scope under NDA. Tool-calling, MCP, agent evals for next-gen conversational AI.',
}

export const metadata = {
  title: `${caseStudy.client} Case Study`,
  description: caseStudy.description,
  alternates: { canonical: '/work/meta-superintelligence' },
  openGraph: {
    type: 'article',
    url: '/work/meta-superintelligence',
