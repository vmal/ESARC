...
export const article = {
  ...
  description:
    'Notes on AI-assisted development, rendering patterns, and what changes in web engineering when half the work is being done by agents.',
  author: {
...
export const metadata = {
  ...
  alternates: { canonical: '/insights/future-of-web-development' },
  openGraph: {
    type: 'article',
    url: '/insights/future-of-web-development',
    title: article.title,
    description: article.description,
  },
}
