...
export const article = {
  ...
  description:
    'A short retrospective on what changed when a remote team moved back to a shared room, and which of those things were worth the move.',
  author: {
...
export const metadata = {
  ...
  alternates: { canonical: '/insights/3-lessons-we-learned-going-back-to-the-office' },
  openGraph: {
    type: 'article',
    url: '/insights/3-lessons-we-learned-going-back-to-the-office',
    title: article.title,
    description: article.description,
  },
}
